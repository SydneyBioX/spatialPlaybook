...
*Note:* You can specify additional covariates and include a subject id for mixed effects survival modelling, see [spicyR](https://bioconductor.org/packages/release/bioc/html/spicyR.html) for more information.
