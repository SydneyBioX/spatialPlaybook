...
1.  Are we seeing exclusivity amongst markers which are biologically exclusive? E.g. we don't expect to see a CD3+ (T cell marker) and CD68+ (Macrophage marker) cluster.
2.  Can we tease out cell types given the markers?
:::
...
1.  We're generally looking for the `k` before the point of greatest inflection.
2.  There can be several options of `k` if there are several points of inflection. Choose the `k` which best reflects the number of clusters you expect to get from the tissue.
:::
