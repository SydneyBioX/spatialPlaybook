...
This section demonstrates how to evaluate the quality of segmentation performed with simpleSeg in the previous step. It also introduces additional functions and packages for data normalisation and transformation to address batch effects.
...
```{r 02-loadFergusondata, message=FALSE, warning=FALSE}
